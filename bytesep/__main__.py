...
def download_checkpoints(args) -> NoReturn:
    ...
    for checkpoint_name in checkpoint_names:
        ...
        remote_checkpoint_link = zenodo_dir+ '/'+ checkpoint_name
    ...
    remote_zip_scripts_link = zenodo_dir+ '/'+ "train_scripts.zip?download=1"
...
def get_paths(source_type: str, model_type: str) -> [str, str]:
    ...
    if model_type == "MobileNet_Subbandtime":
        ...
        if source_type == "vocals":
            ...
            checkpoint_path = local_checkpoints_dir + '/' + "mobilenet_subbtandtime_vocals_7.2dB_500k_steps_v2.pth"
            ...
            checkpoint_path = local_checkpoints_dir+ '/'+"mobilenet_subbtandtime_accompaniment_14.6dB_500k_steps_v2.pth"
